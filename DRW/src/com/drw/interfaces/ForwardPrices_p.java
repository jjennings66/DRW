...
public class ForwardPrices_p implements IScript {
	...
	private void setFileLocation(Table tAsk) throws OException {
		int iRetVal = -1;
		try {
			Ask.setTextEdit(tAsk, "File Path", "C:\\", ASK_TEXT_DATA_TYPES.ASK_FILENAME, "Enter Forward Prices Import File Path", 1, 2);
			iRetVal = Ask.viewTable(tAsk, "Forward Prices Import", "Forward Prices Import");
