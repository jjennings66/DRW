...
/*
Script Name: DRW_DealImportCancelAndPurgeTestDealsCommTrans
Description:  DRW_DealImportCancelAndPurgeTestDealsCommTrans
...
public class DRW_DealImportCancelAndPurgeTestDealsCommTrans implements IScript {
	...
	public void execute(IContainerContext context) throws OException {
		...
		try {
			...
			FUNC.doEverything(INS_TYPE_ENUM.comm_transport, iRunNumber, className);
